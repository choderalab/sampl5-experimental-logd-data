...
See `Manuscript` for all files used to generate figures and tables for the manuscript.

See `bootstrap_code/bootstrap_model.py` for our bootstrap analysis code. 
